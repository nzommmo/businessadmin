        ...
        {error ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {loading ? (
                <div className="text-sm text-red-500">Loading suppliers...</div>
              ) : (
                <Select
                id="supplier"
                name="supplier"
                className="text-black"
                  ...
                  required
                >
                  <SelectTrigger className="w-full border rounded px-3 py-2 text-black bg-white focus:ring-0 focus:ring-offset-0">
                    <SelectValue className='placeholder:text-black' placeholder="Select a supplier" />
                  </SelectTrigger>
                  <SelectContent>
